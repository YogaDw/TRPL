			...
			<div class="show-top-grids">
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<?php                  
$query = mysqli_query($con, "SELECT * FROM video WHERE id='$_GET[kd]'");
...
?>
                   ...
                   <!--      <video class="img-fluid d-block mb-4 w-100 img-thumbnail" src="img/<?php echo $data['gambar']; ?>"> </div> -->
                      
                        <source src="upload/<?php echo $data['video']; ?>" type="video/mp4"> 
                        	<source src="upload/<?php echo $data['video']; ?>" type="video/ogg"> 
                        		<source src="upload/<?php echo $data['video']; ?>" type="video/webm"> 
                            </video>
						<!-- <iframe src="upload/<?php echo $data['video']; ?>" allowfullscreen></iframe> --> 
						</div>
					</div>
					...
					<div class="published">
						...
						<embed src="upload/<?php echo $data['materi']; ?>" width="550" height="600"> </embed>
