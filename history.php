...
<!DOCTYPE HTML>
<html>
<head> <link rel="icon" type="image/png" href="images/A.png">
<title>History</title>
			...
			<div class="header-top-right">
					...
					<!-- pop-up-box -->
									...
									<div id="small-dialog7" class="mfp-hide">
										...
										<!-- <form method="POST" action="proseslogin.php" enctype="multipart/form-data">
												<input type="text" class="email" placeholder="Email" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?" title="Enter a valid email" name ="email"/>
				...
				<div class="signin">
					...
					<div id="small-dialog" class="mfp-hide">
						...
						<div class="signup">
							<form method="POST" action="proseslogin.php" enctype="multipart/form-data">
								<input type="text" class="email" name ="email" placeholder="Enter email" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?"/>
								<input type="password" name ="password" placeholder="Password" required="required" pattern=".{6,}" title="Minimum 6 characters required" autocomplete="off" />
			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li><a href="miniquis.php" class="news-icon"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>Mini Quiz</a></li>
					<li><a href="#" class="menu1"><span class="glyphicon glyphicon-film" aria-hidden="true"></span>Grammar<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
						...
						<li><a href="#" class="menu1"><span class="glyphicon glyphicon-music" aria-hidden="true"></span>Listening<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
					...
					<li><a href="#" class="menu"><span class="glyphicon glyphicon-film" aria-hidden="true"></span>Speaking<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
				  ...
				  <!-- script-for-menu -->
					...
					<div class="side-bottom">
						...
						<div class="copyright">
							<p>Copyright © 2018 Trepple Video<a href="http://w3layouts.com/">TRPL 2018</a></p>
						</div>
					</div>
				</div>
        </div>
				...
				<div class="main-grids news-main-grids">
					<div class="recommended-info">
						...
						<div class="col-md-11 history-right">
								...
								<h5> Chartin Wulan Alhana (16241010101130)</h5>
								<P>PROJEK MANAGER</P>
								<p>"Terkadang kamu perlu meluangkan sedikit waktu untuk merenung, merenungi apa yang telah kamu lewati dalam hidupmu"</p>
							</div>
							<div class="clearfix"> </div>
						</div>
							...
							<div class="col-md-11 history-right">
								...
								<h5>SURYA PRAYOGA (162410101135)</h5>
								<p>PROGRAMMER</p>
								<p>"Satu tindakan jauh lebih "Bijak" dibandingkan ribuan Kata Kata Mutiara dan rancana-rencana yang masih tetap bertenggeng dikepala.</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="history-grids">
							...
							<div class="col-md-11 history-right">
								...
								<h5>Resi Uji Maulana (162410101126)</h5>
								<P>TESTER</P>
								<p>"Dan tujuan hidup yang baik akan membawamu kedalam kebahagiaan yang hakiki"</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="history-grids">
							...
							<div class="col-md-11 history-right">
								...
								<h5> Barep Jati Kusuma (162410101042)</h5>
								<P>DESAINER</P>
								<p>"Pertanyaan-pertanyaan semacam itu jelas akan membuat kamu mencari dan menemukan tujuan hidup kamu yang sebenarnya"</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="col-md-11 history-right">
								...
								<h5>Rosyidah Amatullah Widodo (162410101022)</h5>
								<P>ANALYS</P>
								<p>"Dari sebuah perenungan yang mendalam, akan tercipta sebuah pertanyaan yang begitu besar. Dan pertanyaan itu tak lain adalah "Sebenarnya apa tujuan saya dihidupkan dan kenapa saya dihidupkan?""</p>
							</div>
							<div class="clearfix"> </div>
						</div>
