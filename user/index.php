...
if(mysqli_num_rows($result) ==0){
  ...
  ?>
						<div class="col-md-3 resent-grid recommended-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="videoplay.php?hal=videoplay&kd=<?php echo $data['id'];?>"?><img src="images/play3.jpg" alt="" /></a>
							...
							<div class="resent-grid-info recommended-grid-info video-info-grid">
								        <h5>  <a href="videoplay.php?hal=videoplay&kd=<?php echo $data['id'];?>"><?php echo $data['name']; ?></a></h5>
						<!-- 		<h5><a href="videoplay.php" class="title">Varius sit sed viverra viverra nullam nullam interdum metus</a></h5> -->
								<ul>
									<li><p class="author author-info"><a href="#" class="author">Trepple video</a></p></li>
  ...
  ?> 
				...
				<!-- 		<div class="col-md-3 resent-grid recommended-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="single.php"><img src="images/play3.jpg" alt="" /></a>
								<div class="time small-time">
									<p>3:02</p>
								</div>
								<div class="clck small-clck">
						...
						<div class="col-md-3 resent-grid recommended-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="single.html"><img src="images/play3.jpg" alt="" /></a>
								<div class="time small-time">
									<p>1:34</p>
								</div>
								<div class="clck small-clck">
